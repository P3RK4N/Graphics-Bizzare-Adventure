...
namespace Engine
{
	class PointLightDemo : public DrawableApplicationComponent
	{
		RTTI_DECLARATIONS(PointLightDemo, DrawableApplicationComponent)

	public:
		PointLightDemo(Application* app, Camera* camera)
	...
	private:
		...
		PointLightDemo(const PointLightDemo&) = default;
